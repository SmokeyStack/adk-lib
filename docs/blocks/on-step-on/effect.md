# adk_lib:on_step_on_effect

## What does it do?

This component will give the entity that steps on the block the specified effect.

## How to use

Add `"adk_lib:on_step_on_effect": {}` to your block json file.
